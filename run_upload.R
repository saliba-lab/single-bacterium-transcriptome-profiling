...
## Fig1c
p1 <- ggplot(data = colData[colData$n.cells == "single", ], aes(x = n.cells, y = n.gene, color = n.cells)) +
  geom_jitter() + 
  geom_violin(alpha = 0) +
  theme_classic() +
...
p2 <- ggplot(data = colData[colData$n.cells == "ten", ], aes(x = n.cells, y = n.gene, color = n.cells)) +
  geom_jitter() + 
  geom_violin(alpha = 0) +
  theme_classic() +
  ylab("") +
...
ggsave("./output/Fig1c.pdf", Fig1c, width = 6, height = 5)
...
ggsave("./output/Fig1d.pdf", Fig1d, width = 8, height = 6)
...
ggsave("./output/sFig2b.pdf", sFig2b, width = 10, height = 5)
...
ggsave("./output/sFig2a.pdf", sFig2a, width = 12, height = 4)
...
sFig5b <- grid.arrange(lib_pca_ten, n.gene_pca_ten, ncol=2)
ggsave("./output/sFig5b.pdf", sFig5b, width = 10)
          
## sFig5c_left
fviz_eig(res.pca, addlabels = TRUE, ylim = c(0, 20))
ggsave("./output/sFig5c_left.pdf")
...
ggsave("./output/sFig5b_biplot.pdf", height = 4, width = 3.5)
...
sFig5a <- grid.arrange(lib_pca_single, n.gene_pca_single, ncol=2)
ggsave("./output/sFig5a.pdf", sFig5a, width = 10)
 

## Fig2a         
Fig2a <- grid.arrange(pca_single, pca_ten, ncol=1)
ggsave("./output/Fig2a.pdf", Fig2a, height = 12)
          
## sFig5c_right
fviz_eig(res.pca, addlabels = TRUE, ylim = c(0, 20))
ggsave("./output/sFig5c_right.pdf")
...
ggsave("./output/sFig5a_biplot.pdf", height = 4, width = 3)
#############################################################################
...
ggsave("./output/sFig4a.pdf", sFig4a, width = 20, height = 6)
...
ggsave("./output/sFig4b.pdf", sFig4b, width = 20, height = 6)
...
filenames <- list.files(path = "./non_unique_summary", full.names = TRUE)
...
ggsave("./output/sFig2c_ten.pdf", width = 6, height = 3)
...
## sFig2c_single
ggsave("./output/sFig2_single.pdf", width = 6, height = 3)   
...
ggsave("./output/Fig2c_single_salt_histogram.pdf")
...
ggsave("./output/Fig2c_single_salt_boxplot.pdf", width = 2)
...
ggsave("./output/Fig2c_ten_salt_histogram.pdf")
...
ggsave("./output/Fig2c_ten_salt_boxplot.pdf", width = 2)
...
ggsave("./output/Fig2c_ten_ana_histogram.pdf")
...
ggsave("./output/Fig2c_ten_ana_boxplot.pdf", width = 2)